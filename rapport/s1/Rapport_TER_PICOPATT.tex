...
\begin{subfigure}[b]{0.3\textwidth}
    \centering
    \includegraphics[width=\textwidth]{rapport/s1/Images/Parcours/Place de la Comédie.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{analyse_exploratoire/figures/comptage/nb_passages_distincts_par_Mslot.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{analyse_exploratoire/figures/comptage/heatmap_counts_parcours_M.png}
...
\begin{subfigure}[b]{0.325\textwidth}
  \centering
  \includegraphics[width=\textwidth]{analyse_exploratoire/figures/comptage/presence_passages/presence_passages_antigone.png}
  \caption{Antigone}
\end{subfigure}\hspace{0.05mm}
\begin{subfigure}[b]{0.325\textwidth}
  \centering
  \includegraphics[width=\textwidth]{analyse_exploratoire/figures/comptage/presence_passages/presence_passages_boulevards.png}
  \caption{Boulevards}
\end{subfigure}\hspace{0.05mm}
\begin{subfigure}[b]{0.325\textwidth}
  \centering
  \includegraphics[width=\textwidth]{analyse_exploratoire/figures/comptage/presence_passages/presence_passages_ecusson.png}
  \caption{Écusson}
\end{subfigure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.57\textwidth]{analyse_exploratoire/figures/controle_qualite/boxplot_tair_means.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.57\textwidth]{analyse_exploratoire/figures/controle_qualite/boxplot_tair_means_clean.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{analyse_exploratoire/figures/controle_qualite/timeseries_tair_tc1_m1.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{analyse_exploratoire/figures/controle_qualite/tmrt_pet.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{analyse_exploratoire/figures/comptage/na_pct_vars_meteo.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{analyse_exploratoire/figures/comptage/na_pct_vars_meteo_clean.png}
...
\begin{subfigure}[t]{0.3\textwidth}
  \centering
  \includegraphics[width=\textwidth]{analyse_exploratoire/figures/distribution/distribution_globale/dist_global_ws.png}
...
\begin{subfigure}[t]{0.3\textwidth}
  \centering
  \includegraphics[width=\textwidth]{analyse_exploratoire/figures/distribution/distribution_globale/dist_global_pet.png}
...
\begin{subfigure}[t]{0.3\textwidth}
  \centering
  \includegraphics[width=\textwidth]{analyse_exploratoire/figures/distribution/distribution_parcours/antigone/dist_antigone_pet.png}
  \caption{Antigone}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.3\textwidth}
  \centering
  \includegraphics[width=\textwidth]{analyse_exploratoire/figures/distribution/distribution_parcours/boulevards/dist_boulevards_pet.png}
  \caption{Boulevards}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.3\textwidth}
  \centering
  \includegraphics[width=\textwidth]{analyse_exploratoire/figures/distribution/distribution_parcours/ecusson/dist_ecusson_pet.png}
  \caption{Écusson}
\end{subfigure}
...
\begin{subfigure}{0.3\textwidth}
  \centering
  \includegraphics[width=\textwidth]{analyse_exploratoire/figures/distribution/distribution_sections/antigone/section_1/dist_antigone_section1_pet.png}
  \caption{Antigone, section 1}
\end{subfigure}
\hfill
\begin{subfigure}{0.3\textwidth}
  \centering
  \includegraphics[width=\textwidth]{analyse_exploratoire/figures/distribution/distribution_sections/antigone/section_37/dist_antigone_section37_pet.png}
  \caption{Antigone, section 37}
\end{subfigure}
\hfill
\begin{subfigure}{0.3\textwidth}
  \centering
  \includegraphics[width=\textwidth]{analyse_exploratoire/figures/distribution/distribution_sections/antigone/section_75/dist_antigone_section75_pet.png}
...
\begin{subfigure}[t]{0.6\textwidth}
  \centering
  \includegraphics[width=\linewidth,height=0.62\textheight,keepaspectratio]{analyse_exploratoire/figures/distribution/distributions_variables/pet/dist_pet_ecusson.png}
  \caption{Écusson}
...
\begin{subfigure}[t]{0.35\textwidth}
  ...
  \begin{subfigure}[t]{\linewidth}
    \centering
    \includegraphics[width=\linewidth,height=0.29\textheight,keepaspectratio]{analyse_exploratoire/figures/distribution/distributions_variables/pet/dist_pet_antigone.png}
    \caption{Antigone}
  ...
  \begin{subfigure}[t]{\linewidth}
    \centering
    \includegraphics[width=\linewidth,height=0.29\textheight,keepaspectratio]{analyse_exploratoire/figures/distribution/distributions_variables/pet/dist_pet_boulevards.png}
    \caption{Boulevards}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth]{analyse_exploratoire/figures/compare_box_violin/compare_rh_thermohygro_parcours.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth]{analyse_exploratoire/figures/compare_box_violin/compare_tmrt_parcours.png}
...
\centering
\includegraphics[width=\linewidth]{analyse_exploratoire/figures/correlation/corr_antigone.png}
\caption{Antigone}
\label{corr_Antigone}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.3\linewidth}
\centering
\includegraphics[width=\linewidth]{analyse_exploratoire/figures/correlation/corr_boulevards.png}
\caption{Boulevards}
\label{corr_Boulevards}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.3\linewidth}
\centering
\includegraphics[width=\linewidth]{analyse_exploratoire/figures/correlation/corr_ecusson.png}
\caption{Ecusson}
\label{corr_Ecusson}
\end{subfigure}
...
\begin{subfigure}[t]{0.4\linewidth}
  \centering
  \includegraphics[width=\linewidth]{analyse_exploratoire/figures/correlation/par_mslot/corr_antigone_M1.png}
  \caption{M1}
...
\begin{subfigure}[t]{0.4\linewidth}
  \centering
  \includegraphics[width=\linewidth]{analyse_exploratoire/figures/correlation/par_mslot/corr_antigone_M4.png}
  \caption{M4}
...
\begin{subfigure}[t]{0.4\linewidth}
  \centering
  \includegraphics[width=\linewidth]{analyse_exploratoire/figures/correlation/par_mslot/corr_boulevards_M1.png}
  \caption{M1}
...
\begin{subfigure}[t]{0.4\linewidth}
  \centering
  \includegraphics[width=\linewidth]{analyse_exploratoire/figures/correlation/par_mslot/corr_boulevards_M4.png}
  \caption{M4}
...
\begin{subfigure}[t]{0.3\linewidth}
\centering
\includegraphics[width=\linewidth]{analyse_exploratoire/figures/correlation/par_mslot/corr_ecusson_M1.png}
\caption{M1}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.3\linewidth}
\centering
\includegraphics[width=\linewidth]{analyse_exploratoire/figures/correlation/par_mslot/corr_ecusson_M2.png}
\caption{M2}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.3\linewidth}
\centering
\includegraphics[width=\linewidth]{analyse_exploratoire/figures/correlation/par_mslot/corr_ecusson_M4.png}
\caption{M4}
\end{subfigure}
...
\begin{subfigure}[t]{0.32\textwidth}
  \centering
  \includegraphics[width=\textwidth]{analyse_exploratoire/figures/profil/comparer_moyenne_mslot/profil_sw_right_Mslots.png}
  \caption{Profil de \texttt{sw\_right}.}
  \label{fig:profil_sw_right_mslots}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.32\textwidth}
  \centering
  \includegraphics[width=\textwidth]{analyse_exploratoire/figures/profil/comparer_moyenne_mslot/profil_tmrt_Mslots.png}
  \caption{Profil de \texttt{tmrt}.}
  \label{fig:profil_tmrt_mslots}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.32\textwidth}
  \centering
  \includegraphics[width=\textwidth]{analyse_exploratoire/figures/profil/comparer_moyenne_mslot/profil_lw_down_Mslots.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.55\textwidth]{analyse_exploratoire/figures/profil/comparer_moyenne_mslot/profil_ws_Mslots.png}
...
\begin{subfigure}[t]{0.48\textwidth}
  \centering
  \includegraphics[width=\linewidth]{analyse_exploratoire/figures/profil/profils_temps/profils_temps_antigone.png}
  \caption{Antigone}
  \label{fig:profil_tair_antigone_mslots}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.48\textwidth}
  \centering
  \includegraphics[width=\linewidth]{analyse_exploratoire/figures/profil/profils_temps/profils_temps_boulevards.png}
  \caption{Boulevards}
...
\begin{subfigure}[t]{0.32\textwidth}
  \centering
  \includegraphics[width=\textwidth]{analyse_exploratoire/figures/profil/point/antigone/9janv._M2/profil_lw_down_antigone_9janv._M2.png}
  \caption{Antigone, M2 (le 9 janvier)}
  \label{fig:lwdown_antigone_m2_9janv}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.32\textwidth}
  \centering
  \includegraphics[width=\textwidth]{analyse_exploratoire/figures/profil/point/boulevards/7janv._M2/profil_lw_down_boulevards_7janv._M2.png}
  \caption{Boulevards, M2 (7 janvier)}
  \label{fig:lwdown_boulevards_m2_7janv}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.32\textwidth}
  \centering
  \includegraphics[width=\textwidth]{analyse_exploratoire/figures/profil/point/ecusson/14janv._M2/profil_lw_down_ecusson_14janv._M2.png}
...
\begin{subfigure}[b]{0.48\linewidth}
  \centering
  \includegraphics[width=\linewidth]{analyse_exploratoire/figures/profil/comparer_meme_date/antigone/9janv/profil_compare_lw_down_antigone_9janv..png}
  \caption{Antigone, le 9 janvier (M1 à M4)}
  \label{fig:lwdown_antigone_journee}
\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\linewidth}
  \centering
  \includegraphics[width=\linewidth]{analyse_exploratoire/figures/profil/comparer_meme_date/boulevards/7janv/profil_compare_lw_down_boulevards_7janv..png}
...
\begin{subfigure}[b]{0.48\linewidth}
  \centering
  \includegraphics[width=\linewidth]{analyse_exploratoire/figures/profil/comparer_meme_date/ecusson/14janv/profil_compare_lw_down_ecusson_14janv..png}
...
\begin{subfigure}[b]{0.48\linewidth}
  \centering
  \includegraphics[width=\linewidth]{analyse_exploratoire/figures/profil/comparer_meme_Mslot/antigone/M2/profil_compare_lw_down_antigone_M2.png}
  \caption{Antigone, M2 (plusieurs dates)}
  \label{fig:lwdown_antigone_m2_multidates}
\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\linewidth}
  \centering
  \includegraphics[width=\linewidth]{analyse_exploratoire/figures/profil/comparer_meme_Mslot/boulevards/M2/profil_compare_lw_down_boulevards_M2.png}
...
\begin{subfigure}[b]{0.48\linewidth}
  \centering
  \includegraphics[width=\linewidth]{analyse_exploratoire/figures/profil/comparer_meme_Mslot/ecusson/M2/profil_compare_lw_down_ecusson_M2.png}
