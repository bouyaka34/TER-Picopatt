...
METADATA = ROOT / "outputs" / "heatmap_tmrt_montpellier_10m_filters" / "tmrt_montpellier_10m_filtres_metadata.json"
MAIN_METADATA = ROOT / "outputs" / "heatmap_tmrt_montpellier_10m" / "tmrt_montpellier_10m_metadata_catboost.json"
MAIN_PREDICTIONS = ROOT / "outputs" / "heatmap_tmrt_montpellier_10m" / "tmrt_montpellier_10m_predictions_catboost.csv"
ROUTE_PREDICTIONS = ROOT / "outputs" / "heatmap_tmrt" / "tmrt_predictions_grid_or_points.csv"
CLEAN_NOZEROS = ROOT / "outputs" / "clean_nozeros"
HEATMAP_TILE_SOURCE = ROOT / "outputs" / "figures" / "heatmap_tmrt_montpellier_10m" / "tmrt_montpellier_10m_overlay_catboost_smooth2x.png"
HEATMAP_EXPORT = ROOT / "outputs" / "figures" / "heatmap_tmrt_montpellier_10m" / "tmrt_montpellier_10m_overlay_catboost_smooth2x.webp"
APP_DIR = ROOT / "outputs" / "webapp_tmrt_montpellier"
...
def build_payload() -> dict:
    ...
    return {
        ...
        "main_heatmap": {
            ...
            "image_url": "../figures/heatmap_tmrt_montpellier_10m/tmrt_montpellier_10m_overlay_catboost_smooth2x.webp",
            "export_url": "../figures/heatmap_tmrt_montpellier_10m/tmrt_montpellier_10m_overlay_catboost_smooth2x.webp",
